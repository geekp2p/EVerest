...
set "OTHER_PATTERNS=*.json .env docker* *.go *.mod *.sum *.md Dockerfile* *.sh requirements.txt emu.log droidflow.log docker-compose.yml environment.yml supervisord.conf *.conf"
